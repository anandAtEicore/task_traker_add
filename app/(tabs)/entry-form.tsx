...
//   const closeAlert: CloseAlert = () => setAlert(null);
...
//         {alert && (
//           <Alert action={alert.action} style={styles.alert}>
//             <VStack style={styles.alertContent}>
//               <AlertText style={styles.alertText}>{alert.message}</AlertText>
//               {alert.action === "success" && (
//                 <Btn style={styles.alertButton} onPress={closeAlert}>
...
//     justifyContent: 'flex-end',    // Starts from the end (right side)
//     alignItems: 'center',          // Vertically centers the content
//     padding: 8,                    // Adds some padding around the button
//     marginVertical: 4, 
//   },
//   buttonRow: {
//     flexDirection: "row",
...
//     backgroundColor: "#4CAF50", // Consistent green from your web theme
//     paddingVertical: 10,
...
//     backgroundColor: "#A0A0A0", // Grayed out when disabled
//     opacity: 0.7,
//   },
// });
